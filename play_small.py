...
model = SOLIS(embed_dim=512, ff_dim=512, num_heads=16, num_layers=6).to(DEVICE)
...
for DEPTH in DEPTHS:
    PGN_SAVE_PATH = f'/data/hamaraa/solis_small_d{DEPTH}_w{WIDTH}_vs_stockfish_d{DEPTH}.pgn'
    # === MAIN BENCHMARK LOOP ===
