...
SCORE_CACHE = LRU(capacity=600_000) # zobrist -> float alignment score
TT = {}
...
def score_positions(boards):
    ...
    batch = torch.tensor(toks, dtype=torch.long, device=DEVICE, non_blocking=True)
